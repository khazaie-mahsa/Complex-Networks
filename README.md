...
|-------------|------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|
| Communism   | Singular delta-distribution, peaked at the single value a: ρ( x ) = δ( x − a)      | Random Regular Graph                                                                                | All incomes are equal                                                     |
...
```python
    while True:
        ...
        if nx.is_valid_degree_sequence_havel_hakimi(sequence): # check sequence to see if the generated sequence is valid
            break
